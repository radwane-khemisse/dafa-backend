...
from app.services.offer_pricing import get_offer_prices, get_pack_market_details, get_pack_prices, get_product_market_details
...
def create_order(
    ...
    try:
        ...
        calculated_items = calculate_items(
            payload.items,
            get_offer_prices(db, market["code"]),
            get_pack_prices(db, market["code"]),
